...
const Precios = () => {
    return ( 
		...
		<section class="text-gray-600 body-font overflow-hidden bg-gray-200 md:bg-background-2 bg-no-repeat md:bg-white" id="section3">
			  ...
			  <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
				<div class="h-full p-6 rounded-lg  flex flex-col relative overflow-hidden bg-white shadow-md">
				  ...
				  <p class="flex items-center text-gray-600 mb-2">
					...
					</span>Dirección Web en Easy Turno
				  </p>
				  <button
						className=" items-center mt-auto text-white bg-blue-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-blue-600 rounded "
					>
					Elegir
					</button>
				</div>
			  ...
			  <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
				<div class="h-full p-6 rounded-lg border-2 border-blue-500 flex flex-col relative overflow-hidden bg-white shadow-md">
				  ...
				  <p class="flex items-center text-gray-600 mb-2">
					...
					</span>Integración a la web de tu negocio
				  </p>
				  <p class="flex items-center text-gray-600 mb-2">
					<span class="w-4 h-4 mr-2 inline-flex items-center justify-center bg-green-500 text-white rounded-full flex-shrink-0">
					  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
					...
					</span>QR con acceso a tu Easy Turno
				  </p>
