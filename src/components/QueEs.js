...
const QueEs = () => {
    return (
        <div className="container max-w-full mx-auto py-20 px-6">
            <h1
			className="text-center text-4xl text-gray-700 font-bold leading-snug" data-aos="fade-right" id="section1"
			>
			¿Qué es?
		    </h1>
            <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-6xl mx-auto" data-aos="fade-right">
                ...
                <div className="text-left font-medium text-3xl leading-10 text-gray-700 mt-2 px-6  self-center" data-aos="fade-right">
