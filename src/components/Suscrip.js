...
const Suscrip = () => {
    ...
    <div className=" container mx-auto content-center align-center bg-white flex items-center justify-center px-5 py-5">
                        ...
                        <div className="md:flex -mx-3">
                            <div className="md:w-1/2 px-3 mb-5">
                                ...
                                <div className="flex">
                                    ...
                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 text-gray-700" placeholder="Nombre"></input>
                                </div>
                            </div>
                            <div className="md:w-1/2 px-3 mb-5">
                                ...
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 text-gray-700" placeholder="Nombre del negocio"></input>
                                </div>
                            </div>
                        </div>
                        <div className="md:flex -mx-3">
                            <div className="md:w-1/2 px-3 mb-5">
                                ...
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 text-gray-700" placeholder="Teléfono"></input>
                                </div>
                            </div>
                            <div className="md:w-1/2 px-3 mb-5">
                                ...
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 text-gray-700" placeholder="Email"></input>
                                </div>
                            </div>
                        </div>
                        {/* <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5">
                                ...
                                <div className="flex">
                                    ...
                                    <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="ejemplo@gmail.com"></input>
                                </div>
                            </div>
                        </div> */}
                        <div className="flex -mx-3">
