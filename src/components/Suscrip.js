...
import suscri from '../assets/img/como.svg';
...
const Suscrip = () => {
    ...
    const handleSubmit = e => {
        ...
        emailjs.sendForm('service_igde7xi', 'template_yt66dnm', e.target, 'user_DjxbpiGhrI5bsn5NN7Lm7')
          .then((result) => {
    ...
    <div className="container mx-auto content-center align-center flex items-center justify-center w-screen h-screen">
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" >
            <div className="md:flex w-full">
                <div className="hidden md:block w-1/2 bg-purple-700 py-10 px-10">
                    <img src={suscri} alt="man mobile"/>
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div className="text-center mb-10 text-gray-700">
                        <h1 className="font-bold text-3xl">¡Muchas Gracias por suscribirte!</h1>
                        ...
                        <div className="md:flex -mx-3">
                            <div className="md:w-1/2 px-3 mb-5">
                                ...
                                <div className="flex">
                                    ...
                                    <input type="text" name="nombre" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 text-gray-700" placeholder="Nombre"  onChange={handleSubmit}></input>
                                </div>
                            </div>
                            <div className="md:w-1/2 px-3 mb-5">
                                <label for="" className="text-xs font-semibold px-1">Nombre del negocio</label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" name="nombre_negocio" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 text-gray-700" placeholder="Nombre del negocio" onChange={handleSubmit}></input>
                                </div>
                            </div>
                        </div>
                        <div className="md:flex -mx-3">
                            <div className="md:w-1/2 px-3 mb-5">
                                <label for="" className="text-xs font-semibold px-1">Teléfono</label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" name="telefono" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 text-gray-700" placeholder="Teléfono" onChange={handleSubmit}></input>
                                </div>
                            </div>
                            <div className="md:w-1/2 px-3 mb-5">
                                ...
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" name="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500 text-gray-400" placeholder="Email"></input>
                                </div>
                            </div>
                        </div>
                        {/* <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5">
                                <label for="" className="text-xs font-semibold px-1">Email de gmail para conectarlo con Goolge Calendar</label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                    <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-400 outline-none focus:border-indigo-500" placeholder="ejemplo@gmail.com"></input>
                                </div>
                            </div>
                        </div> */}
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5" type="submit" value="send message">
                                <button className="block w-full mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
